...
public class WorldClockBoard extends JComponent
{
  ...
  public WorldClockBoard()
  {
    ...
    URL imageDayURL = WorldClockBoard.class.getResource("/lh/worldclock/core/world.jpg");
    URL imageNightURL = WorldClockBoard.class.getResource("/lh/worldclock/core/world_night.jpg");
  ...
  {
//    System.out.println("sz w=" + width + ", h=" + height);
    super.setSize(width, height);
    updateSizeValues(width, height);
  }
  ...
  {
//    System.out.println("cx = " + newWidth + ", cy = " + newHeight);
    width = newWidth;
    height = newHeight;
    if (width < 1 || height < 1)
      return;
